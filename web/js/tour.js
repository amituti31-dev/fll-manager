...
function buildTourSteps() {
  const steps = [
    ...
    { screen: 'robot', selector: '.mission-notes-btn', title: '✏️ עריכה מלאה לכל משימה',
    ...
    { screen: 'robot', selector: '#robot-import-json-btn', title: '📥 ייבוא משימות מ-JSON', adminOnly: true,
    ...
    { screen: 'robot', selector: '[data-action="reset-missions-default"]', title: '🔄 איפוס משימות', adminOnly: true,
    ...
    { screen: 'scoring', selector: '#scoring-missions-card', title: '📋 סימון משימות',
      text: 'סמנו אילו משימות ביצעתם בריצה הזו — הניקוד מתעדכן אוטומטית. אם למשימה מוגדר בונוס, תופיע לידה תיבת סימון נוספת עם מספר הנקודות — סמנו אותה באותה קלות כדי להוסיף אותן לניקוד.' },
    ...
    { screen: 'settings', selector: '#settings-team-card', title: '👥 פרטי קבוצה',
      text: 'שינוי שם הקבוצה, שם העונה (למשל בתחילת עונה חדשה) והלוגו — למנטורים בלבד.', adminOnly: true },
